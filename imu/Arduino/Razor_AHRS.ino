...
#define ACCEL_X_MIN ((float) -329)
#define ACCEL_X_MAX ((float) 278)
#define ACCEL_Y_MIN ((float) -257)
#define ACCEL_Y_MAX ((float) 344)
...
#define CALIBRATION__MAGN_USE_EXTENDED true
const float magn_ellipsoid_center[3] = {145.866, -60.5409, -7.38750};
const float magn_ellipsoid_transform[3][3] = {{0.925925, 0.0129078, -0.00139610}, {0.0129078, 0.940235, 0.00641326}, {-0.00139610, 0.00641326, 0.999312}};
